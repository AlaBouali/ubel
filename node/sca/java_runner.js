...
export class JavaMavenScanner {
  ...
  // ─────────────────────────────
  _mavenPurl(groupId, artifactId, version) {
  ...
  // ─────────────────────────────
  _scanProject(projectRoot, visited) {
  ...
  async getInstalled(startDir) {
    ...
    if (this._isMavenRoot(startDir)) {
      raw.push(...this._scanProject(startDir, visited));
    }
